        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        <a href="course_selected.html" class="active"><i class="fa fa-check"></i> 已选课程</a>
                    </li>
                    <li>
        ...
        table = $('#dataTables-example').DataTable({
            ...
            columnDefs : [{
                ...
                render : function (data, type, row, meta) {
                    return "<a type='button' class='btn btn-link' style='padding: 0px 0px' onclick=detail('" + row.no + "')>退选此课程</a>";
                }
            },
                {
                    targets : 1,
            ...
            ajax : {
                url : "course_selected?no=" + get_cookie("sno"),
                dataSrc : ""
            },
            language : {
                "emptyTable" : "暂无数据",
        ...
        $.confirm({
            ...
            buttons : {
                ok : {
                    ...
                    action : function () {
                        $.ajax({
                            url : 'drop_course?sno=' + get_cookie("sno") + '&cno=' + no,
                            dataType : "html",
